...
const (
	DeliveryMode_DELIVERY_MODE_AT_LEAST_ONCE_UNSPECIFIED DeliveryMode = 0
...
var (
	DeliveryMode_name = map[int32]string{
		0: "DELIVERY_MODE_AT_LEAST_ONCE_UNSPECIFIED",
		1: "DELIVERY_MODE_AT_MOST_ONCE",
	}
	DeliveryMode_value = map[string]int32{
		"DELIVERY_MODE_AT_LEAST_ONCE_UNSPECIFIED": 0,
...
type Publish struct {
	...
	Mode     DeliveryMode `protobuf:"varint,3,opt,name=mode,proto3,enum=directmq.v1.DeliveryMode" json:"mode,omitempty"`
...
func (x *Publish) GetClientId() string {
	if x != nil {
		return x.ClientId
	}
	return ""
...
func (x *Publish) GetMode() DeliveryMode {
	if x != nil {
		return x.Mode
	}
	return DeliveryMode_DELIVERY_MODE_AT_LEAST_ONCE_UNSPECIFIED
}
...
var file_directmq_v1_publish_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x73, 0x68, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x69,
	...
	0x52, 0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x12, 0x2d, 0x0a, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6d, 0x71,
	0x2e, 0x76, 0x31, 0x2e, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x4d, 0x6f, 0x64, 0x65,
	0x52, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x04,
	...
	0x6c, 0x6f, 0x61, 0x64, 0x2a, 0x5b, 0x0a, 0x0c, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79,
	0x4d, 0x6f, 0x64, 0x65, 0x12, 0x2b, 0x0a, 0x27, 0x44, 0x45, 0x4c, 0x49, 0x56, 0x45, 0x52, 0x59,
	...
	0x00, 0x12, 0x1e, 0x0a, 0x1a, 0x44, 0x45, 0x4c, 0x49, 0x56, 0x45, 0x52, 0x59, 0x5f, 0x4d, 0x4f,
	0x44, 0x45, 0x5f, 0x41, 0x54, 0x5f, 0x4d, 0x4f, 0x53, 0x54, 0x5f, 0x4f, 0x4e, 0x43, 0x45, 0x10,
...
var file_directmq_v1_publish_proto_goTypes = []interface{}{
	(DeliveryMode)(0), // 0: directmq.v1.DeliveryMode
	(*Publish)(nil),   // 1: directmq.v1.Publish
}
var file_directmq_v1_publish_proto_depIdxs = []int32{
	0, // 0: directmq.v1.Publish.mode:type_name -> directmq.v1.DeliveryMode
